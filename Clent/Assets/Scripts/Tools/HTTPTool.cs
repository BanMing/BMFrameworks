...
public class HTTPTool
{
    ...
    public static void UpLoadFiles(string url, List<string> fileds, List<byte[]> bytes, List<string> files,List<string> otherDataKeys,List<string>otherDataValues,  Action<string> CallBack)
    {
        ScriptThread.Instance.StartCoroutine(upLoadFiles(url, fileds, bytes, files, otherDataKeys,otherDataValues, CallBack));
    }
