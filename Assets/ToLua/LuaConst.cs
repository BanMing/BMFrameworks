...
public static class LuaConst {
    ...
    public static string toluaCsDir = Application.dataPath + "/ToLua/Core"; //tolua cs文件路径
    ...
    public static string luaResDir =MyFileUtil.CacheDir+ "Lua"; //lua逻辑代码目录 //手机运行时lua文件下载目录    
    public static string toluaResDir =MyFileUtil.CacheDir+ "Lua/ToLua"; //lua逻辑代码目录 //手机运行时lua文件下载目录    
