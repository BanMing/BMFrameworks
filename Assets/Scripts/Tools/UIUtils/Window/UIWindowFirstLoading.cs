...
public class UIWindowFirstLoading : SingletonMonoBehaviour<UIWindowFirstLoading>
{
    ...
    static public void Show()
    {
        if (m_Instance != null)
        {
            Util.SetActive(Instance.transform, true);
        }
    }
    ...
    static public void Hide()
    {
        if (m_Instance != null)
        {
            Util.SetActive(Instance.transform, false);
        }
    }
    ...
    static public void HideUpdateItems()
    {
        if (m_Instance!=null)
        {
            Util.SetActive(Instance.m_Dice, false);
            Util.SetActive(Instance.m_Text.transform, false);
            Util.SetActive(Instance.m_RotateCircle, false);
        }
    }
}
