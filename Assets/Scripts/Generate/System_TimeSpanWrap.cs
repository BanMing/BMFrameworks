...
public class System_TimeSpanWrap
{
	...
	static int CompareTo(IntPtr L)
	{
		try
		{
			...
			if (count == 2 && TypeChecker.CheckTypes(L, 1, typeof(System.TimeSpan), typeof(System.TimeSpan)))
			{
			...
			else if (count == 2 && TypeChecker.CheckTypes(L, 1, typeof(System.TimeSpan), typeof(object)))
			{
				System.TimeSpan obj = (System.TimeSpan)ToLua.ToObject(L, 1);
