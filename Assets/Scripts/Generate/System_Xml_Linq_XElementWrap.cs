...
public class System_Xml_Linq_XElementWrap
{
	...
	static int _CreateSystem_Xml_Linq_XElement(IntPtr L)
	{
		try
		{
			...
			if (count == 1 && TypeChecker.CheckTypes(L, 1, typeof(System.Xml.Linq.XName)))
			{
			...
			else if (count == 1 && TypeChecker.CheckTypes(L, 1, typeof(System.Xml.Linq.XStreamingElement)))
			{
				System.Xml.Linq.XStreamingElement arg0 = (System.Xml.Linq.XStreamingElement)ToLua.CheckObject(L, 1, typeof(System.Xml.Linq.XStreamingElement));
				System.Xml.Linq.XElement obj = new System.Xml.Linq.XElement(arg0);
				ToLua.PushObject(L, obj);
				return 1;
			}
			else if (count == 1 && TypeChecker.CheckTypes(L, 1, typeof(System.Xml.Linq.XElement)))
			{
			...
			else if (count == 2 && TypeChecker.CheckTypes(L, 1, typeof(System.Xml.Linq.XName), typeof(object)))
			{
				System.Xml.Linq.XName arg0 = (System.Xml.Linq.XName)ToLua.CheckObject(L, 1, typeof(System.Xml.Linq.XName));
			...
			else if (TypeChecker.CheckTypes(L, 1, typeof(System.Xml.Linq.XName)) && TypeChecker.CheckParamsType(L, typeof(object), 2, count - 1))
			{
				System.Xml.Linq.XName arg0 = (System.Xml.Linq.XName)ToLua.CheckObject(L, 1, typeof(System.Xml.Linq.XName));
	...
	static int Attribute(IntPtr L)
	{
		try
		{
			...
			System.Xml.Linq.XElement obj = (System.Xml.Linq.XElement)ToLua.CheckObject(L, 1, typeof(System.Xml.Linq.XElement));
	...
	static int Attributes(IntPtr L)
	{
		try
		{
			...
			if (count == 1 && TypeChecker.CheckTypes(L, 1, typeof(System.Xml.Linq.XElement)))
			{
				System.Xml.Linq.XElement obj = (System.Xml.Linq.XElement)ToLua.ToObject(L, 1);
				System.Collections.Generic.IEnumerable<System.Xml.Linq.XAttribute> o = obj.Attributes();
				ToLua.PushObject(L, o);
				return 1;
			}
			else if (count == 2 && TypeChecker.CheckTypes(L, 1, typeof(System.Xml.Linq.XElement), typeof(System.Xml.Linq.XName)))
			{
				System.Xml.Linq.XElement obj = (System.Xml.Linq.XElement)ToLua.ToObject(L, 1);
	...
	static int Load(IntPtr L)
	{
		try
		{
			...
			else if (count == 1 && TypeChecker.CheckTypes(L, 1, typeof(System.Xml.XmlReader)))
			{
			...
			else if (count == 2 && TypeChecker.CheckTypes(L, 1, typeof(System.Xml.XmlReader), typeof(System.Xml.Linq.LoadOptions)))
			{
				System.Xml.XmlReader arg0 = (System.Xml.XmlReader)ToLua.ToObject(L, 1);
			...
			else if (count == 2 && TypeChecker.CheckTypes(L, 1, typeof(string), typeof(System.Xml.Linq.LoadOptions)))
			{
				string arg0 = ToLua.ToString(L, 1);
				System.Xml.Linq.LoadOptions arg1 = (System.Xml.Linq.LoadOptions)ToLua.ToObject(L, 2);
				System.Xml.Linq.XElement o = System.Xml.Linq.XElement.Load(arg0, arg1);
			...
			else if (count == 2 && TypeChecker.CheckTypes(L, 1, typeof(System.IO.TextReader), typeof(System.Xml.Linq.LoadOptions)))
			{
				System.IO.TextReader arg0 = (System.IO.TextReader)ToLua.ToObject(L, 1);
				System.Xml.Linq.LoadOptions arg1 = (System.Xml.Linq.LoadOptions)ToLua.ToObject(L, 2);
				System.Xml.Linq.XElement o = System.Xml.Linq.XElement.Load(arg0, arg1);
	...
	static int Save(IntPtr L)
	{
		try
		{
			...
			if (count == 2 && TypeChecker.CheckTypes(L, 1, typeof(System.Xml.Linq.XElement), typeof(System.IO.TextWriter)))
			{
				System.Xml.Linq.XElement obj = (System.Xml.Linq.XElement)ToLua.ToObject(L, 1);
			...
			else if (count == 2 && TypeChecker.CheckTypes(L, 1, typeof(System.Xml.Linq.XElement), typeof(System.Xml.XmlWriter)))
			{
				System.Xml.Linq.XElement obj = (System.Xml.Linq.XElement)ToLua.ToObject(L, 1);
			...
			else if (count == 2 && TypeChecker.CheckTypes(L, 1, typeof(System.Xml.Linq.XElement), typeof(string)))
			{
				System.Xml.Linq.XElement obj = (System.Xml.Linq.XElement)ToLua.ToObject(L, 1);
			...
			else if (count == 3 && TypeChecker.CheckTypes(L, 1, typeof(System.Xml.Linq.XElement), typeof(System.IO.TextWriter), typeof(System.Xml.Linq.SaveOptions)))
			{
				System.Xml.Linq.XElement obj = (System.Xml.Linq.XElement)ToLua.ToObject(L, 1);
				System.IO.TextWriter arg0 = (System.IO.TextWriter)ToLua.ToObject(L, 2);
			...
			else if (count == 3 && TypeChecker.CheckTypes(L, 1, typeof(System.Xml.Linq.XElement), typeof(string), typeof(System.Xml.Linq.SaveOptions)))
			{
				System.Xml.Linq.XElement obj = (System.Xml.Linq.XElement)ToLua.ToObject(L, 1);
				string arg0 = ToLua.ToString(L, 2);
				System.Xml.Linq.SaveOptions arg1 = (System.Xml.Linq.SaveOptions)ToLua.ToObject(L, 3);
	...
	static int ReplaceAll(IntPtr L)
	{
		try
		{
			...
			if (count == 2 && TypeChecker.CheckTypes(L, 1, typeof(System.Xml.Linq.XElement), typeof(object)))
			{
				System.Xml.Linq.XElement obj = (System.Xml.Linq.XElement)ToLua.ToObject(L, 1);
	...
	static int get_FirstAttribute(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index FirstAttribute on a nil value" : e.Message);
		}
	}
	...
	static int get_LastAttribute(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index LastAttribute on a nil value" : e.Message);
		}
	}
	...
	static int get_HasAttributes(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index HasAttributes on a nil value" : e.Message);
		}
	}
	...
	static int get_HasElements(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index HasElements on a nil value" : e.Message);
		}
	}
