...
public class ResourcesManagerWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("DecryptLuaCode", DecryptLuaCode);
	...
	static int FixShader(IntPtr L)
	{
		try
		{
			...
			else if (count == 1 && TypeChecker.CheckTypes<ResourcesManager.LoadedAssetBundle>(L, 1))
			{
	...
	static int UnloadAssetBundle(IntPtr L)
	{
		try
		{
			...
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to method: ResourcesManager.UnloadAssetBundle");
			}
		}
		catch (Exception e)
		{
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int DecryptLuaCode(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 1);
			byte[] arg0 = ToLua.CheckByteBuffer(L, 1);
			byte[] o = ResourcesManager.DecryptLuaCode(arg0);
			ToLua.Push(L, o);
			return 1;
		}
		catch (Exception e)
	...
	static int GetUIInstanceSync(IntPtr L)
	{
		try
		{
			...
			string arg0 = ToLua.CheckString(L, 2);
			string arg1 = ToLua.CheckString(L, 3);
			UnityEngine.GameObject o = obj.GetUIInstanceSync(arg0, arg1);
			ToLua.PushSealed(L, o);
			return 1;
		}
		catch (Exception e)
	...
	static int get_m_DictShader(IntPtr L)
	{
		try
		{
			ToLua.PushSealed(L, ResourcesManager.m_DictShader);
			return 1;
		}
		catch (Exception e)
		{
	...
	static int get_ResourcesRoot(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o, "attempt to index ResourcesRoot on a nil value");
		}
	}
