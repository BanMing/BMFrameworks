...
public class DG_Tweening_TweenWrap
{
	...
	static int get_stringId(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index stringId on a nil value" : e.Message);
		}
	}
	...
	static int get_onPause(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index onPause on a nil value" : e.Message);
		}
	}
	...
	static int get_onRewind(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index onRewind on a nil value" : e.Message);
		}
	}
	...
	static int get_onKill(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index onKill on a nil value" : e.Message);
		}
	}
	...
	static int get_onWaypointChange(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index onWaypointChange on a nil value" : e.Message);
		}
	}
